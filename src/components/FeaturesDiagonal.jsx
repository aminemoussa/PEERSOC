...
export const FeaturesDiagonal = () => {
  ...
  return (
    <section className="lg:mb-16 w-full flex flex-col justify-center items-center bg-bgDark1">
      ...
      >
        <div className="2xl:w-[1150px] xl:w-[1050px] md:w-4/5 flex flex-col items-center justify-center">
          <div className="w-3/4 lg:w-1/2 flex flex-col items-center">
            ...
            <p className="mb-16 text-secondaryText leading-loose text-center">
              Our SOC excels in successful deployments, active client service,
              thorough penetration tests, and effective threat detection,
              ensuring robust protection and continuous security for our
              clients.
            </p>
            <button
              className="w-[210px] h-12 contained-button"
